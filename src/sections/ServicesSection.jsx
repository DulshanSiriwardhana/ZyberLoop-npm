      ...
      <div className="flex items-center justify-center z-20">
        <div className="flex flex-col justify-center items-center mt-16 space-y-5 px-0 max-w-[1600px]">
          ...
          <div className="flex flex-col gap-8 px-10 ">
            <ServiceCard
              imageSrc="/src/assets/images/development.webp"
            ...
            <ServiceCard
              imageSrc="/src/assets/images/mobile.webp"
            ...
            <ServiceCard
              imageSrc="/src/assets/images/erpsystem.webp"
              title="ERP Solutions"
            ...
            <ServiceCard
              imageSrc="/src/assets/images/cloudComputing.webp"
            ...
            />
            <ServiceCard
              imageSrc="/src/assets/images/logodesign.webp"
            ...
            <ServiceCard
              imageSrc="/src/assets/images/socialmedia.webp"
